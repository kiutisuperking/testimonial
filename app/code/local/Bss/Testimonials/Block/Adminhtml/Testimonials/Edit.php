...
class Bss_Testimonials_Block_Adminhtml_Testimonials_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		public function __construct()
		{
				...
				if(!Mage::getSingleton('admin/session')->isAllowed('testimonials/testimonials/actions/edit')){
